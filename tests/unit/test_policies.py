...
async def test_check_static_analysis_misconfigurations():
    ...
    result_found = await policy.check_static_analysis_misconfigurations("path/to/contract.sol")
    ...
    result_not_found = await policy.check_static_analysis_misconfigurations("path/to/another_contract.sol")
