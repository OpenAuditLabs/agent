...
class TestValidator:
    ...
    def test_validate_address(self):
        ...
        assert (
            Validator.validate_address("  0x1234567890123456789012345678901234567890  ")
            is True
        )
        assert (
            Validator.validate_address("0x1234567890123456789012345678901234567890")
        ...
        assert (
            Validator.validate_address("abcdef1234567890abcdef1234567890abcdef")
            is False
        )  # Missing 0x
        assert (
            Validator.validate_address("0xabcdef1234567890abcdef1234567890abcde")
            is False
        )  # Too short
