...
*   **Align with Database Schema:** (Assumed, requires verification) These lengths are intended to correspond with the underlying database column sizes for `name` and `description` fields.
